...
renderer.toneMappingExposure = 1.5;
    ...
    rgbeLoader.load(HDR, (texture) => {
      ...
      scene.backgroundBlurriness = 0; // 场景的背景模糊程度
      scene.backgroundIntensity = 1; // 场景的背景图片强度
    });
...
// environmentMap.colorSpace = THREE.SRGBColorSpace;  // 新版本使用这个
    ...
    const sphereMaterial = new THREE.MeshPhysicalMaterial({
      metalness: 1,     // 稍微降低金属度，让材质不会太黑
      roughness: 0.0,     // 降低粗糙度，增加反射的清晰度
    ...
    // 下面两个要共同使用    'NoToneMapping', 'LinearToneMapping', 'ReinhardToneMapping', 'CineonToneMapping', 'ACESFilmicToneMapping',
     renderer.toneMapping = THREE.LinearToneMapping; // 色
