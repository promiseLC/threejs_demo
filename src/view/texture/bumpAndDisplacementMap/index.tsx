  ...
  useEffect(() => {
    ...
    const sceneManager = {
      ...
      createGeometry() {
        ...
        // 创建一个立方体
        const cubeGeometry = new THREE.BoxGeometry(2, 2, 2,64,64);
        ...
        console.log(cubeGeometry,material);
      ...
      createGui() {
        ...
        this.gui.add(this.material, 'bumpScale').min(0).max(100).step(0.1);
        this.gui.add(this.material, 'displacementScale').min(0).max(1).step(0.1);
        this.gui.add(this.material, 'displacementBias').min(0).max(1).step(0.1);
      },
