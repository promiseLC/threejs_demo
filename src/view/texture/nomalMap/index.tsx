...
import woodTexture from '../../../assets/textures/Glass_Vintage_001/Glass_Vintage_001_basecolor.jpg';
import normalTexture from '../../../assets/textures/Glass_Vintage_001/Glass_Vintage_001_normal.jpg';
  ...
  useEffect(() => {
    ...
    const sceneManager = {
      ...
      loadTexture() {
        ...
        this.normalTexture = new THREE.TextureLoader().load(normalTexture, (t) => {
          t.needsUpdate = true;
        });
      ...
      createGeometry() {
        ...
        const sphereGeometry1 = new THREE.SphereGeometry(2, 32, 32);

        const cubeMesh = new THREE.Mesh(sphereGeometry, material);
        const cubeMesh1 = new THREE.Mesh(sphereGeometry1, material1);

        this.cubeMesh = cubeMesh;

        cubeMesh.position.set(0, 0, 0);
        cubeMesh1.position.set(-1.5, 0, 0);
      ...
      createGui() {
        ...
        this.gui.add(this.material.normalScale, 'x').min(0).max(10).step(0.1)
        this.gui.add(this.material.normalScale, 'y').min(0).max(10).step(0.1)
        this.gui.add(this.dirLight.position, 'z').min(0).max(10).step(0.1)
