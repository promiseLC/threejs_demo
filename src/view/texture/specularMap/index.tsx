...
import woodTexture from '../../../assets/textures/earth/earth_atmos_2048.jpg';
import specularTexture from '../../../assets/textures/earth/earth_specular_2048.jpg';
  ...
  useEffect(() => {
    ...
    const sceneManager = {
      ...
      loadTexture() {
        ...
        this.specularTexture = new THREE.TextureLoader().load(specularTexture, (t) => {
          t.needsUpdate = true;
        });
    ...
    this.roughnessTexture.colorSpace = THREE.SRGBColorSpace;
      ...
      createGui() {
        ...
        // this.gui.add(this.material, 'envMapIntensity').min(0).max(1).step(0.01);
        // this.gui.add(this.cubeMesh.rotation, 'y').min(0).max(180).step(0.01);

        this.gui.add(this.material, 'shininess').min(0).max(1000).step(1);

        this.gui.addColor({ color: 0x00ffff },'color').onChange(val => {
